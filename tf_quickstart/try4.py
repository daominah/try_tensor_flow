...
from common import my_input_fn
...
# training_examples.describe().to_csv("temp1.csv")
training_targets = preprocess_targets(california_housing_dataframe.head(12000))
# training_targets.describe().to_csv("temp2.csv")
validation_examples = preprocess_features(
    california_housing_dataframe.tail(5000))
# validation_examples.describe().to_csv("temp3.csv")
validation_targets = preprocess_targets(california_housing_dataframe.tail(5000))
# validation_targets.describe().to_csv("temp4.csv")
...
plt.scatter(validation_examples["longitude"],
            ...
            cmap="coolwarm",
            c=validation_targets["median_house_value"] / validation_targets[
...
plt.scatter(training_examples["longitude"],
            ...
            cmap="coolwarm",
            c=training_targets["median_house_value"] / training_targets[
                "median_house_value"].max())
_ = plt.plot()
