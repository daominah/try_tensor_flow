"""
Summary:
    - Sigmoid and Softplus but not ReLU, are continuous functions with
    continuous inverses. They are bijections.
    - Bijections activation function dont affect topology, only stretch space
